...
/**
 * @title NFTAuctionUpgradeable NFT拍卖系统
 * @dev NFT在线拍卖系统，英式拍卖
    ...
    ContextUpgradeable
{
    ...
    function createAuction(
        ...
        // 验证所有权是否是seller
        require(nft.ownerOf(tokenId) == _msgSender(), "nft not owner");
    ...
    function setAuctionStatus(uint256 auctionId, bool flag) external {
        ...
        require(acutionMaps[auctionId].seller == _msgSender(), "Only seller");
